  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.html">Bowshop<span>.</span></a>
		        ...
		        <div class="col-md-6 mb-5 mb-md-0">
		          ...
		          <div class="p-3 p-lg-5 border bg-white">
		            ...
		            <div class="form-group row mb-5">
		              ...
		              <div class="col-md-6">
		                <label for="c_phone" class="text-black">Nomor HP <span class="text-danger">*</span></label>
		                ...
		                <div class="py-2">
		                  ...
		                  <div class="form-group">
		                    ...
		                    <select id="c_diff_country" class="form-control">
		                      ...
		                      <option value="6">Turki</option>    
		                      <option value="7">Jerman</option>    
		                      <option value="8">Colombia</option>    
		                      <option value="9">Majalaya</option>    
		                    </select>
		                  </div>
		            ...
		            <div class="col-md-12">
		              ...
		              <div class="p-3 p-lg-5 border bg-white">
		                <table class="table site-block-order-table mb-5">
		                  ...
		                  <tbody>
		                    <tr>
		                      <td>{{ $produk->nama }} <strong class="mx-2">x</strong> 1</td>
		                ...
		                <div class="form-group">
		                  <button class="btn btn-black btn-lg py-3 btn-block" href="thankyou" onclick="window.location='thankyou'">Place Order</button>
		                </div>
