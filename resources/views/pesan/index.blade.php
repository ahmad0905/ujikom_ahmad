...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('detail-produk/assets/img/apple-icon.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('detail-produk/assets/img/favicon.ico')}}">

    <link rel="stylesheet" href="{{asset('detail-produk/assets/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('detail-produk/assets/css/templatemo.css')}}">
    <link rel="stylesheet" href="{{asset('detail-produk/assets/css/custom.css')}}">
    ...
    <!-- Slick -->
    <link rel="stylesheet" type="text/css" href="{{asset('detail-produk/assets/css/slick.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('detail-produk/assets/css/slick-theme.css')}}">
    <!--
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('image/' . $produk->image) }}" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
